...
public class MypageLikeResponseDTO {
    ...
    @Schema(title = "찜 목록 아이디", description = "마이페이지 찜 목록의 찜 목록 ID입니다.")
    private int id;

    @Schema(title = "글 아이디", description = "공유 글 ID입니다.")
    private int shareArticleId;

    @Schema(title = "찜 목록 수정 시간", description = "마이페이지 찜 목록의 찜 목록 수정 시간입니다.")
