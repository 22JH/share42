...
const UserCommunityDetail = () => {
  ...
  const Detail_API = (id: string | undefined) => {
    return `https://www.share42-together.com:8088/api/user/community/posts/${id}/${PAGE}/${SIZE}`;
  };

  const Post_Comment_API = () => {
    return `https://www.share42-together.com:8088/api/user/community/comments`;
  };
